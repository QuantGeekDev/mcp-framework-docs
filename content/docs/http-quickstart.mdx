...
description: Create and use HTTP MCP servers with the HTTP Stream Transport
---
...
2. **Authentication**: Add authentication to protect your endpoints. The framework supports various authentication providers like API keys and JWT tokens. See the [Authentication Options](authentication/overview) documentation for more details.
...
- Learn more about [HTTP Stream Transport](transports/http-stream)
- Explore [Authentication Options](authentication/overview)
