---
title: Installation
description: How to install and set up the MCP Framework
---
...
2. Learn about [Tools](tools/overview)
3. Explore [Resources](resources/overview)
4. Check out [Prompts](prompts/overview)
