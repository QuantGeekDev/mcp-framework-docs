...
description: Using the default STDIO transport for CLI tools and local integrations
---
...
For scenarios requiring multiple clients, network access, or authentication, consider using [SSE Transport](./sse) instead.
...
Ready to build your first STDIO-based MCP server? Follow our [Quickstart Guide](../quickstart) to create and run a project using the STDIO Transport in just a few minutes.
