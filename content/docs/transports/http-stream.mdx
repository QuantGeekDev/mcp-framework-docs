...
description: Modern HTTP-based transport with streaming, session management, and authentication
---
...
Ready to build your first HTTP-based MCP server? Follow our [HTTP Quickstart Guide](../http-quickstart) to create and run a project using the HTTP Stream Transport in just a few minutes. 
